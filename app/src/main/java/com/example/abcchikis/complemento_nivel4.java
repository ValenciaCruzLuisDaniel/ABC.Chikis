...
public class complemento_nivel4 extends AppCompatActivity {
    int recorrido=27,imagenrandom,errores,intentos;
    ImageView imagenes;
    Button opa,opb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complemento_nivel4);

        imagenes = findViewById(R.id.im4);
        opa = findViewById(R.id.op4);
        opb = findViewById(R.id.op5);
    ...
    private void validarBoton(String vocalboton){
        ...
        if (errores==15){
            Toast.makeText(this, "Haz cometido 15 errores volvamos a intentarlo", Toast.LENGTH_LONG).show();
            ...
            if(recorrido>intentos){
                if(!vocalboton.equalsIgnoreCase(correcto())){
                ...
                if(hola.obtenerProgresoActualizadoPorNivel(4)>100){
                    Toast.makeText(this, "tarea completa bien hecho", Toast.LENGTH_LONG).show();
                    Intent menu= new Intent(getApplicationContext(), listaniveles.class );
                    startActivity(menu);
                }
                else{
                    hola.actualizarProgreso(4,100);
                    Toast.makeText(this, "tarea completa bien hecho", Toast.LENGTH_LONG).show();
                    Intent menu= new Intent(getApplicationContext(), listaniveles.class );
                    startActivity(menu);
                }
    ...
    private void siguiente() {
        ...
        imagenrandom = numero.nextInt(27);
